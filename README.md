...
- Reconstruct philosophers using public domain texts
- Encourage critical thinking
- Make philosophical dialogue accessible
- Optimize for multilingual users (especially Korean)
- Run efficiently on lightweight environments (e.g., laptops)
...
- LLM-based architecture (Llama models)
